...
\033[1;91m☞ CODER     : @NABIL RAHMAN✅
\033[1;95m☞ EMAIL    : rjnabilrahman@gmail.com
...
def menu():
	...
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' Nabil New Update Cloning')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Nabil Tool')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/nabil')
	    os.system('cd $HOME && git clone https://github.com/nabil-404/Cloner-V2')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Nabil Tool')
	    psb('Congratulations Nabil Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Nabil✓')
	    psb('🔓Password ☆ Rahman✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Cloner-V2 && python2 nabil.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsauKakzK8op6gpf9Xqr')
	    menu()
	elif bm =='4':
